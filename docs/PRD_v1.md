...
|---|---|---|
| 역할 | 125편 순서대로 채워지는 여정의 감각 | 본인이 학습한 레슨의 궤적 기록 |
...
|---|---|---|---|
| **125편 커리큘럼 체계 + 고유 레슨 ID** | P1 (3.80) · 원칙 5 | ChatGPT·유튜브 대비 **완결 구조** | LESSON 스키마, 콘텐츠 제작 파이프라인 |
...
**LESSON**
- `lesson_id`: 문자열 포맷 `L001` ~ `L125`. 원칙 5 준수 — 고유·불변.
